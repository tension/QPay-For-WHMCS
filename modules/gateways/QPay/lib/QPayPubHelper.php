...
*/
	...
	include_once("QPay.pub.config.php");
/**
 * 所有接口的基类
 */
 ...
 * 请求型接口的基类
 */
class QPay_client_pub extends Common_util_pub 
{
	...
	function createXml()
	{
	   	//$this->parameters["appid"] = QPayConf_pub::APPID;//公众账号ID
 ...
 * 订单查询接口
 */
class OrderQuery_pub extends QPay_client_pub
{
	function __construct() 
	{
		//设置接口链接
 ...
 * 退款申请接口
 */
class Refund_pub extends QPay_client_pub
{
 ...
 * 退款查询接口
 */
class RefundQuery_pub extends QPay_client_pub
{
 ...
 * 对账单接口
 */
class DownloadBill_pub extends QPay_client_pub
{
	function __construct() 
	{
		//设置接口链接
 ...
 * 响应型接口基类
 */
class QPay_server_pub extends Common_util_pub 
{
 ...
 * 通用通知接口
 */
class Notify_pub extends QPay_server_pub 
{
}
/**
 * 请求商家获取商品信息接口
 */
class NativeCall_pub extends QPay_server_pub
{
	/**
	 * 生成接口参数xml
	 */
	function createXml()
	{
		if($this->returnParameters["return_code"] == "SUCCESS"){
		   	//$this->returnParameters["appid"] = QPayConf_pub::APPID;//公众账号ID
		   	$this->returnParameters["mch_id"] = QPayConf_pub::MCHID;//商户号
